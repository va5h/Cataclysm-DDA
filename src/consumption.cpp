...
std::int64_t Character::get_acquirable_energy( const item &it, rechargeable_cbm cbm ) const
{
    switch( cbm ) {
        ...
        case rechargeable_cbm::other:
            ...
            const std::int64_t to_charge = static_cast<std::int64_t>( it.fuel_energy() * to_consume * bid->fuel_efficiency );
            return to_charge;
    }
...
std::int64_t Character::get_acquirable_energy( const item &it ) const
{
