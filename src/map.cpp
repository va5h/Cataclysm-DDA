...
int map::move_cost( const point &p, const vehicle *ignored_vehicle ) const
{
...
void map::i_rem( const point &p, item *it )
{
...
void map::add_item( const point &p, item new_item )
{
